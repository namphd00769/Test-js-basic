...
// khi click vao tung sp thi se lay duoc NODE cua chinh no
function productOnOver(node) {

   var productsElement = document.getElementsByClassName("product");
   for (var i = 0; i < productsElement.length; i++) {
      var productElement = productsElement[i];
      productElement.setAttribute("class", "product");
   }

   node.setAttribute("class", "product active");
}
...
function renderProduct() {
   ...
   for (var i = 0; i < products.length; i++) {
      ...
      product_html += '<li class="product"  onmouseover = "productOnOver(this)">';
      product_html += '<div class="product-img">';
      product_html += '<img src="' + product.image + '">';
      product_html += '</div>';
      product_html += '<div class="product-info">';
      product_html += '<h4 class="product-name">' + product.name + '</h4>';
