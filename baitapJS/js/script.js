...
// danh sach san pham lay tu data base
var products = [
  {
...
/*DAY LA CACH 1 : LAM GOP , MINH CO THE TACH RA CAC BUOC KHI CHUYEN CHU CAI DAU THANH CHU HOA , NHUNG DUNG HAM
*/
/*var product = "";
...
for (var i = 0; i < products.length; i++) {
  ...
  // uppercase first
  var ucName = product.name;
  var First_Name_Uc = ucName.replace(ucName[0], ucName[0].toUpperCase());


  product_html += "<li class='product'>";
  product_html += "<div class='product-img'>"; 
  product_html +=  "<img src=" + product.image + "/>";
  product_html += "</div>"; 
  product_html += "<div class='product-info'>" ; 
  product_html += "<h4 class='product-name'>" + First_Name_Uc +"</h4>";
  product_html += "<p class='product-price'>" + product.price + "</p>";
  product_html += "</div>";
  product_html +=  "</li>";
...
document.getElementById("products").innerHTML = product_html ; 
*/
...
// uppercase first
 function First_Name_Uc(f_name){
  return f_name[0].toUpperCase() + f_name.slice(1);
 }

 // words-Slice
 function wordsSlice(product_name, length) {
  var textArray = product_name.split(' ');
...
for (var i = 0; i < products.length; i++) {
  ...
  product_html += "</div>"; 
  product_html += "<div class='product-info'>" ; 
  product_html += "<h4 class='product-name'>" + wordsSlice( First_Name_Uc(product.name) , 5 ) +"</h4>";
  product_html += "<p class='product-price'>" + product.price + "</p>";
  product_html += "</div>";
  product_html +=  "</li>";
